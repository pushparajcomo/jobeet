...
";
    ...
    public function getflash($type = null, $message = null, $close = null, $use_raw = null, $class = null, $domain = null)
    {
        ...
        try {
            ...
            echo twig_escape_filter($this->env, (($_type_) ? ((" alert-" . $_type_)) : ("")), "html", null, true);
            echo " fade in ";
    ...
    ";
            ...
            if (((array_key_exists("use_raw", $context)) ? (_twig_default_filter($_use_raw_, false)) : (false))) {
                // line 7
                echo "        ";
                if (isset($context["message"])) { $_message_ = $context["message"]; } else { $_message_ = null; }
                if (isset($context["domain"])) { $_domain_ = $context["domain"]; } else { $_domain_ = null; }
                echo $this->env->getExtension('translator')->trans($_message_, array(), ((array_key_exists("domain", $context)) ? (_twig_default_filter($_domain_, "messages")) : ("messages")));
                echo "
    ";
            } else {
                // line 9
                ...
                if (isset($context["message"])) { $_message_ = $context["message"]; } else { $_message_ = null; }
                if (isset($context["domain"])) { $_domain_ = $context["domain"]; } else { $_domain_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans($_message_, array(), ((array_key_exists("domain", $context)) ? (_twig_default_filter($_domain_, "messages")) : ("messages"))), "html", null, true);
                echo "
    ";
            }
            // line 11
...
";
    ...
    ";
            // line 16
            if (isset($context["close_tag"])) { $_close_tag_ = $context["close_tag"]; } else { $_close_tag_ = null; }
            if (((array_key_exists("close_tag", $context)) ? (_twig_default_filter($_close_tag_, false)) : (false))) {
                // line 17
                echo "        ";
                if (isset($context["close_tag"])) { $_close_tag_ = $context["close_tag"]; } else { $_close_tag_ = null; }
                if (($_close_tag_ == true)) {
                ...
                echo "        <";
                if (isset($context["close_tag"])) { $_close_tag_ = $context["close_tag"]; } else { $_close_tag_ = null; }
                echo twig_escape_filter($this->env, $_close_tag_, "html", null, true);
    ...
    ";
            ...
            if (((array_key_exists("heading", $context)) ? (_twig_default_filter($_heading_, false)) : (false))) {
                // line 23
                echo "    <h4 class=\"alert-heading\">";
                if (isset($context["heading"])) { $_heading_ = $context["heading"]; } else { $_heading_ = null; }
                echo twig_escape_filter($this->env, $_heading_, "html", null, true);
                echo "</h4>
    ";
            }
            // line 25
...
";
    ...
    public function getsession_flash($close = null, $use_raw = null, $class = null, $domain = null)
    {
        ...
        try {
            ...
            if ((twig_length_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($_app_, "session"), "flashbag"), "peekAll")) > 0)) {
                // line 35
                echo "        ";
                if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
                $context['_parent'] = (array) $context;
                $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute($this->getAttribute($_app_, "session"), "flashbag"), "all"));
                foreach ($context['_seq'] as $context["type"] => $context["messages"]) {
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["message"]) {
                        ...
                        if (isset($context["class"])) { $_class_ = $context["class"]; } else { $_class_ = null; }
                        if (isset($context["domain"])) { $_domain_ = $context["domain"]; } else { $_domain_ = null; }
                        echo $this->getAttribute($this, "flash", array(0 => $_type_, 1 => $_message_, 2 => $_close_, 3 => $_use_raw_, 4 => $_class_, 5 => $_domain_), "method");
                        echo "
            ";
                    }
