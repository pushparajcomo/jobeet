...
class __TwigTemplate_17d68a75bc3180b25862132672e40d46 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        if ((!twig_test_empty($this->getAttribute($_flow_, "getStepDescriptions", array(), "method")))) {
            // line 4
...
\t\t";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["stepDescription"]) {
                ...
                if (((($this->getAttribute($_flow_, "isAllowDynamicStepNavigation", array(), "method") && ($this->getAttribute($_loop_, "index") != $this->getAttribute($_flow_, "getCurrentStep", array(), "method"))) && $this->getAttribute($_flow_, "isStepDone", array(0 => $this->getAttribute($_loop_, "index")), "method")) && (!$this->getAttribute($_flow_, "hasSkipStep", array(0 => $this->getAttribute($_loop_, "index")), "method")))) {
                    // line 8
                    echo "<a href=\"";
                    if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
                    if (isset($context["flow"])) { $_flow_ = $context["flow"]; } else { $_flow_ = null; }
                    if (isset($context["loop"])) { $_loop_ = $context["loop"]; } else { $_loop_ = null; }
                    echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath($this->getAttribute($this->getAttribute($this->getAttribute($_app_, "request"), "attributes"), "get", array(0 => "_route"), "method"), $this->env->getExtension('craue_formflow')->addDynamicStepNavigationParameter(twig_array_merge($this->getAttribute($this->getAttribute($this->getAttribute($_app_, "request"), "query"), "all"), $this->getAttribute($this->getAttribute($this->getAttribute($_app_, "request"), "attributes"), "get", array(0 => "_route_params"), "method")), $_flow_, $this->getAttribute($_loop_, "index"))), "html", null, true);
                    // line 10
                    echo "\">";
                    // line 11
