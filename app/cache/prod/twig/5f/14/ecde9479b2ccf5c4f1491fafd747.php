...
class __TwigTemplate_5f14ecde9479b2ccf5c4f1491fafd747 extends Twig_Template
{
...
";
    ...
    public function block_craue_flow_stepList_class($context, array $blocks = array())
    {
        ...
        } elseif ($this->getAttribute($_flow_, "hasSkipStep", array(0 => $this->getAttribute($_loop_, "index")), "method")) {
            // line 5
            echo " class=\"craue_formflow_skipped_step\"";
        } elseif ($this->getAttribute($_flow_, "isStepDone", array(0 => $this->getAttribute($_loop_, "index")), "method")) {
            // line 7
